...
var deck = [
	...
	{"texture": preload("res://assets/characters/mensch/4/Graf_Zacharias/Zacharias.png"), "draggable_scene": preload("res://szenen/welt/3d/card/mensch/4/Graf_Zacharias/graf_zacharias.tscn")},
